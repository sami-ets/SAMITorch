...
from samitorch.factories.factories import ModelFactory, CriterionFactory, OptimizerFactory
from samitorch.factories.enums import ResNetModels, Criterions, Optimizers
